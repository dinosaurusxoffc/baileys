    ...
    await authState.keys.transaction(async () => {
      ...
      if (participant) {
        if ((0, WABinary_1.isJidGroup)(destinationJid)) {
          jkt48.attrs.to = destinationJid;
          jkt48.attrs.participant = participant.jid;
        } else if ((0, WABinary_1.areJidsSameUser)(participant.jid, meId)) {
          jkt48.attrs.to = participant.jid;
          jkt48.attrs.recipient = destinationJid;
        } else {
          jkt48.attrs.to = participant.jid;
        }
      } else {
      ...
      if (additionalNodes && additionalNodes.length > 0) {
        jkt48.content.push(...additionalNodes);
      }
      ...
      if (
        ...
        jkt48.content.push(bizNode);
      }
      logger.debug(
        { msgId },
        `sending message to ${participants.length} devices`
      );
      await sendNode(jkt48);
    });
    return msgId;
  };
