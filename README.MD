# <div align='center'>WhatsApp Web API - Modified by Dinosaurus</div>

<div align='center'>

**Baileys - Modified by dinosaurusxoffc**
...
```bash
npm install @dinosaurusxoffc/baileys
```

Use the edge version (no guarantee of stability, but latest fixes + features)
```bash
yarn add @dinosaurusxoffc/baileys@latest
```

Then import your code using:
```javascript
const { default: makeWASocket } = require("@dinosaurusxoffc/baileys")
```
...
```javascript
const makeWASocket = require("@dinosaurusxoffc/baileys").default;
const { useMultiFileAuthState } = require("@dinosaurusxoffc/baileys");
...
```javascript
const makeWASocket = require("@dinosaurusxoffc/baileys").default;
const { DisconnectReason, useMultiFileAuthState } = require("@dinosaurusxoffc/baileys");
...
```javascript
const makeWASocket = require("@dinosaurusxoffc/baileys").default;
const { makeInMemoryStore } = require("@dinosaurusxoffc/baileys");
...
const { downloadMediaMessage, getContentType } = require("@dinosaurusxoffc/baileys");
...
**Need help with this modified version? Contact dinosaurusxoffc 6282135318890**
